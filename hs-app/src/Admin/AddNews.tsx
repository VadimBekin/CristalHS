...
import type { ContentBlock } from '../Interfaces/Interfaces.ts';
...
export default function AddNews({ onSuccess, onCancel }: AddNewsProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        await set(newNewsRef, {
            ...
            views: 0,
            copyCode: formData.copyCode || null,
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm overflow-y-auto">
            <div className="bg-stone-900 rounded-2xl border border-white/10 w-full max-w-4xl max-h-[90vh] overflow-y-auto my-8">
                <div className="p-6">
                    <h2 className="text-2xl font-bold text-white mb-4">Добавить новость</h2>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 bg-stone-800 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500"
                                required
                            />
                        </div>
                        ...
                        <div>
                            <CopyInput
                                ...
                                label="Код для копирования"
                            />
                            <p className="text-xs text-gray-500 mt-1">
                                Пользователи смогут скопировать этот код
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={4}
                                className="w-full px-4 py-2 bg-stone-800 border border-white/10 rounded-lg text-white focus:outline-none focus:border-blue-500"
                                placeholder="Или используйте редактор ниже для более сложного форматирования"
                            />
                        </div>
