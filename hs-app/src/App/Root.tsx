...
export default function Root() {
    ...
    return (
        <div>
            {/* Отдельный фиксированный слой для фона */}
            <div
                className="fixed inset-0 -z-10"
                style={{
                    backgroundImage: `url(${mainFon})`,
            ...
            <div className="relative z-10 min-h-screen flex flex-col">
                            ...
                            <div className="container mx-auto px-4">
                                <div className="flex flex-col py-2 space-y-1">
                                    <NavLink
                                        ...
                                        onClick={closeMenu}
                                        className={({ isActive }) =>
                                            `px-4 py-3 transition-all duration-200 hover:bg-white/10 hover:pl-6 hover:text-yellow-500 ${
                ...
                <footer className="mt-auto bg-gray-900/20 backdrop-blur-md border-t border-white/5 py-6 ">
                    <div className="container mx-auto px-4">
                        <div className="flex flex-col text-gray-200 md:flex-row justify-between items-center gap-4 text-sm">
